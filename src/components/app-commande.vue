      ...
      <div class="scrollContainer">
        <div v-for="e in state.cle.slice().reverse()" class="listElemnt">
          <div class="elementTexts">
            ...
            <div class="manageQte">
              <div class="moins"><img v-on:click="dellToCart(state.platsCommandes.get(e))" class="manageBtn centred"
                                      src="src/img/minus.png"/></div>
              <div class="plus"><img v-on:click="addToCart(state.platsCommandes.get(e))" class="manageBtn centred"
                                     src="src/img/plus.png"/></div>
            </div>
