<template>
  <div id="app">
    ...
    <div class="card centred" id="main_container">
      <div id="recherche">
        <input v-on:input="searchRestaurantsFromServer" type="text" v-model="state.nomRecherche"
...
max-height:100%" src="src/img/photoRestp.jpg"/>
      ...
      <div id="pagination">
        ...
        <div v-if="state.page != pageMax()" class="pagination_element button blue" v-on:click=" derniere_page()">last
        </div>
      </div>
    </div>
  </div>
